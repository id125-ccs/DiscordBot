    ...
    AppContext.discordCommandManager.createSlashCommand("vpanel", "Show verify panel") {
        ...
        executor = object : Executor {
            override fun onCommand(
                ...
                val panelMessage = AppContext.mainConfiguration.serversConfiguration.firstOrNull {
                    it.serverId == executor.guild.idLong
                } ?: return Response.of("Verification panel is not yet configured").setEphemeral()

                val message = channel.sendMessage(
                    MessageCreateBuilder()
                        .setEmbeds(
                            panelMessage.panelMessage.toJDA()
//                            EmbedBuilder()
